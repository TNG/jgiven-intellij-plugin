...
object Annotations {
    private val EXPECTED_SCENARIO_STATE = "com.tngtech.jgiven.annotation.ExpectedScenarioState"
    private val PROVIDED_SCENARIO_STATE = "com.tngtech.jgiven.annotation.ProvidedScenarioState"
    private val SCENARIO_STATE = "com.tngtech.jgiven.annotation.ScenarioState"
    ...
    private fun getClassesFor(project: Project, classNames: Collection<String>): Collection<PsiClass> {
        return classNames
                .map { findPsiClass(it, JavaPsiFacade.getInstance(project), project) }
                .filter { it != null }
                .map { it!! }
                .toSet()
    }
